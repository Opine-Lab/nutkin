  ...
  <section id="hero" class="py-20 px-4">
    <div class="max-w-7xl mx-auto text-center">
      <div class="flex justify-center mb-8 scroll-animate scroll-animate-scale">
        <img src="/assets/img/logo.png" alt="Nutkin Logo" class="w-32 h-32 hover:scale-110 transition-transform" />
      </div>
      
      <h1 class="text-5xl md:text-7xl font-bold text-white font-heading mb-6 leading-tight scroll-animate scroll-animate-delay-1">
      ...
      <!-- Stats Bar -->
      <div class="grid grid-cols-2 md:grid-cols-4 gap-4 max-w-4xl mx-auto scroll-animate scroll-animate-delay-4">
